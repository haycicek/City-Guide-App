...
import 'package:gebze/models/weather.dart';
import 'package:gebze/services/api_service.dart';
import 'package:gebze/utilities/colors.dart';
...
class _WeatherScreenState extends State<WeatherScreen> {
  ...
  Widget build(BuildContext context) {
    if (weatherList.isEmpty) {
      ...
      image: AssetImage('assets/bulutresmi.jpeg'), // Resminizin yolunu belirtin
      fit: BoxFit.cover, // Resmi ekranı kaplayacak şekilde ayarlayın
    ),
